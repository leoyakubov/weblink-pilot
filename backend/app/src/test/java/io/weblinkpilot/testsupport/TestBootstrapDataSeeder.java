...
public class TestBootstrapDataSeeder implements ApplicationRunner {
    ...
    public TestBootstrapDataSeeder(UserAccountRepository userAccountRepository,
    ...
    public void run(ApplicationArguments args) {
        ...
        ensureUser(
                ...
                BootstrapDefaults.ADMIN_PASSWORD,
                RoleNames.ADMIN
        );
        ensureUser(
                BootstrapDefaults.USER_USERNAME,
                BootstrapDefaults.USER_PASSWORD,
                RoleNames.USER
        );
        ...
        seedLink("user-home", "https://github.com/weblinkpilot/weblink-pilot/issues", null, BootstrapDefaults.USER_USERNAME, now);
        seedLink("admin-home", "https://github.com/weblinkpilot/weblink-pilot/actions", null, BootstrapDefaults.ADMIN_USERNAME, now);
    }
