...
public class AdminOverviewService {
  ...
  public AdminOverviewResponse overview() {
    ...
    long totalLinks = shortLinkRepository.countByDeletedAtIsNull();
    long anonymousLinks = shortLinkRepository.countByOwnerUsernameIsNullAndDeletedAtIsNull();
    long ownedLinks = shortLinkRepository.countByOwnerUsernameIsNotNullAndDeletedAtIsNull();
